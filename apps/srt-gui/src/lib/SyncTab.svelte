<script lang="ts">
  ...
  import SubtitleListPanel from "./SubtitleListPanel.svelte";
        ...
        >
          {#if !status?.is_loaded}
            <div class="w-full max-w-6xl flex flex-col gap-4 opacity-50 select-none pointer-events-none">
              ...
              >
                <button
                  disabled
                  class="w-14 h-14 flex items-center justify-center rounded-full bg-gradient-to-r from-gray-700 to-gray-800 text-gray-400 shadow-md transition-all cursor-not-allowed opacity-50"
          ...
          {:else}
            <div class="w-full max-w-6xl flex flex-col gap-4 opacity-50 select-none pointer-events-none">
              <div class="text-center flex-shrink-0">
                ...
                >
                  <svg
                    ...
                    /></svg
                  >
                  {t("sync.wizard.checkpoint")} — #0 / {status?.total_subtitles || 0}
                </span>
              </div>
              ...
              >
                <p class="text-xl text-gray-400 font-medium leading-relaxed italic">
                  {t("sync.wizard.selectCheckpoint")}
                </p>
                <p class="text-sm text-gray-500 mt-3 font-mono">
                  00:00.000 → 00:00.000
                </p>
              ...
              >
                <button
                  disabled
                  class="w-14 h-14 flex items-center justify-center rounded-full bg-gray-800 text-gray-400 shadow-md transition-all cursor-not-allowed opacity-50"
                  title={t("sync.playPause")}
                >
                  <svg
                    class="w-7 h-7 text-gray-400 ml-1"
