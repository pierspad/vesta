...
export const transcribeProviders: Record<string, TranscribeProviderInfo> = {
  groq: {
    ...
    description: "Trascrizione Whisper Large v3 su LPU",
  ...
  openai: {
    ...
    description: "API speech-to-text OpenAI (Whisper e GPT-4o Transcribe)",
  ...
  deepgram: {
    ...
    description: "Nova-3 per trascrizione batch con timestamp per parola",
